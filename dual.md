...
{.meta}
[](svg/#south.svg/-0.44,0.62,2.07/+@vimeo-1133751988 "מתוך חשבון האינסטגרם של ניבאל")
[](map/#31.50634,34.45154,12.96,0.0,39.0/+jabalia-gaza(by-car):follow+,+pois.csv(poi,id=home),+pois.csv#2(pois,id=gaza-2403),+idf-poly-outlines)
...
{.meta}
[](svg/#south.svg/-0.14,-0.03,4.68/+tent_rafah "עקורים במחנה אוהלים בח׳אן יונס, 11 בדצמבר 2023. (רויטרס / איברהים אבו מוסטפא)")
[](map/#31.27110,34.25408,16.36,0.0,39.0/+idf-poly-outlines,+pois.csv(poi,id=rafah)) 
...
{.testimony typewriter}
[](svg/#south.svg/-0.55,-1.74,6.64/+tent_rafah,+rita_tent2 "ריתא במחנה העקורים ברפיח")
